...
export default async function RequestDetailPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-semibold">Demande envoyée ✅</h1>
      <p className="mt-2 text-sm text-gray-600">Référence : {req.id}</p>
      ...
      <div className="mt-8 rounded-3xl border bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 flex gap-3">
          ...
          <Link href="/parent/dashboard" className="rounded-2xl bg-black px-5 py-3 text-sm text-white hover:opacity-90">
            Mon espace parent
          </Link>
        </div>
      </div>
